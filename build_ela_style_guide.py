...
def build_html():
    ...
    a(f"""<header class="hero"><div class="wrap">
      ...
      For every interaction type: what a correct screen looks like, the exact values it must carry,
      a copy-paste example you can start from, and how to bring a non-conforming screen into line —
      by hand or with a script.</p>
      <div class="pillrow">
        <span class="pill">6 interaction types</span>
        <span class="pill">178 ELA screens audited</span>
